...
{
    const char* pszTimestamp = "AnachakCoin Start at 2 Jan 2022";
    const CScript genesisOutputScript = CScript() << ParseHex("b5a4f5218b5689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce6842a5b8cf0216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 10051200;
        ...
        genesis = CreateGenesisBlock(1640904872, 2002100997, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xdfe90eb2670ebf7e41f45adea7609d7a36dd05cdac4a94b14f66857349297a82"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2c822c54af11a81fa84534dfe28c7abebd05cfc872fd26bf01ce3a09c21466c"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("node01.anachakcoin.org", "node01.anachakcoin.org", true));
        //vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        //vSeeds.push_back(CDNSSeedData("anachakcointools.com", "dnsseed.anachakcointools.com"));
        //vSeeds.push_back(CDNSSeedData("anachakcoinpool.org", "dnsseed.anachakcoinpool.org"));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0xdfe90eb2670ebf7e41f45adea7609d7a36dd05cdac4a94b14f66857349297a82"))
        ...
        chainTxData = ChainTxData{
            ...
            1640904872, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1640904872, 1385492, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xf6869a6fc0e14389ab756e8cafe3e9e31e775f0d52cfd72b76de07ca67378d3f"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2c822c54af11a81fa84534dfe28c7abebd05cfc872fd26bf01ce3a09c21466c"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("node01.anachakcoin.org", "node01.anachakcoin.org"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.anachakcoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xf6869a6fc0e14389ab756e8cafe3e9e31e775f0d52cfd72b76de07ca67378d3f")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1640904872, 0, 0x207fffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0e5b75191a350aef41377c770775571f7ce594002f23b273613c2fadd2a836c2"));
        assert(genesis.hashMerkleRoot == uint256S("0xc2c822c54af11a81fa84534dfe28c7abebd05cfc872fd26bf01ce3a09c21466c"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x0e5b75191a350aef41377c770775571f7ce594002f23b273613c2fadd2a836c2"))
        };
