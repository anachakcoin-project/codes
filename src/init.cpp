...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/anachakcoin-project/anachakcoin>";
    const std::string URL_WEBSITE = "<https://anachakcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Anachakcoin version %s\n", FormatFullVersion());
}
