...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s anachakcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  anachakcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded anachakcoin transaction") + "\n" +
              "  anachakcoin-tx [options] -create [commands]   " + _("Create hex-encoded anachakcoin transaction") + "\n" +
              "\n";
